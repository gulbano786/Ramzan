...
$stat= json_decode(auto('https://graph.facebook.com/me/home?fields=id,from,comment&limit=1&access_token='.$token),true);
...
$pesan= array(
' Nice  =》 @['.$stat[data][$i-1][from][id].':1] '.$emoticon.'
  RamZan Mubarak 👉 Eid-mubarak .ml 👈  '.$emoticon.' ',
);
